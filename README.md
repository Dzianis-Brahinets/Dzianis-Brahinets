...
<h3>Окончил курс "Тестирования ПО. Артёма Русова.<br>
 Имею опыт создания тестовой документации. Проводил веб-тестирование с использование DevTools.
 Тестировал мобильное приложение на реальном девайсе подключенном к Android Studio.
 Тестировал API в Postman. Работал с базами данных в MySQL (Select, Join, Delete) и MongoDB.
 Перехватывал трафик с помощью CharlesProxy с веб-приложения и мобильного телефона.
 Здесь я хочу поделиться некоторыми элементами полученными во время учебы.</h3>
...
<hr>
<h3><a href="https://drive.google.com/file/d/1ogeIwB0opPgtPmRiwQVxNfja62pZx4-t/view?usp=sharing" target="_blank">Моё резюме</a></h3>
