...
<h2>Привет! Меня зовут Денис и я QA-инженер. Я из Беларуси.</h2>
<h4>Окончил курс "Тестирования ПО. Артёма Русова.<br>
 За время обучения я освоил различные методики тестирования, которые хотелось бы применить в реальном проекте.<br>
 Здесь я хочу поделиться некоторыми элементами портфолио веб-тестирования и мобильного тестирования, полученными во время учебы.</h4>
